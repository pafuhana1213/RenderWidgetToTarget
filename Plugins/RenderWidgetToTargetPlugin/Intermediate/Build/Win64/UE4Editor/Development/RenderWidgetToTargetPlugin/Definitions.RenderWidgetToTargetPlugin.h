#undef RENDERWIDGETTOTARGETPLUGIN_API
...
#define ORIGINAL_FILE_NAME "UE4Editor-RenderWidgetToTargetPlugin.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_PROJECT_NAME RenderWidgetToTarget
...
#define RENDERWIDGETTOTARGETPLUGIN_API DLLEXPORT
